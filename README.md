...
- [`progressive-sainthood.md`](progressive-sainthood.md) — how Scripture makes a saint at once and a saint by degrees: every occurrence of "saints" in both testaments, the three tenses of sanctification, how the New Testament's word for every believer became a title conferred on a few, and how to tell whether you are actually growing
